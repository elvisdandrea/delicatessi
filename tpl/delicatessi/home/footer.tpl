        ...
        <div class="footer">
            ...
            <div class="span_of_3">
                ...
                <div class="span1_of_3">
                    <h3>flickr widget</h3>
                    <ul class="f_nav">
                        <li><a href="#"><img src="{$smarty.const.T_IMGURL}/f_pic1.jpg" alt="" /> </a></li>
                        <li><a href="#"><img src="{$smarty.const.T_IMGURL}/f_pic2.jpg" alt="" /> </a></li>
                        <li><a href="#"><img src="{$smarty.const.T_IMGURL}/f_pic3.jpg" alt="" /> </a></li>
                        <li><a href="#"><img src="{$smarty.const.T_IMGURL}/f_pic4.jpg" alt="" /> </a></li>
                        <li><a href="#"><img src="{$smarty.const.T_IMGURL}/f_pic5.jpg" alt="" /> </a></li>
                        <li><a href="#"><img src="{$smarty.const.T_IMGURL}/f_pic6.jpg" alt="" /> </a></li>
                    </ul>
                </div>
                <div class="clear"></div>
            </div>
